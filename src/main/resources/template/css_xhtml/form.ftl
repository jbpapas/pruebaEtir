...
>
<#if request.getParameter('ventanaBotonLateral')??>
<input type="hidden" id="hid_ventanaBotonLateral" value="${request.getParameter('ventanaBotonLateral')}" name="ventanaBotonLateral">
</#if>
