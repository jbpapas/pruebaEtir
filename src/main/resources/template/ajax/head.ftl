...
<#assign dojoVersion="1.13"> <#-- Aumentar cada vez que se modifica struts_dojo.js -->

<#if parameters.baseRelativePath?if_exists != "">
  <script type="text/javascript" src="<@s.url value='${parameters.baseRelativePath}/${profile}${dojoFile}?${dojoVersion}' includeParams='none' encode='false'  />"></script>
<#else>
  <script type="text/javascript" src="${base}/struts/dojo/${profile}${dojoFile}?${dojoVersion}"></script>
</#if>  
...
<script src="${base}/struts/xhtml/validation.js" type="text/javascript"></script>
