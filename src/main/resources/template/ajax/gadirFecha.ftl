...
<#if parameters.salida?default(false)>
	<div class="campoSalida" title="<@s.property value="parameters.nameValue"/>">
		<#if parameters.nameValue??>
			<@s.property value="%{parameters.nameValue.substring(8,10)+'/'+parameters.nameValue.substring(5,7)+'/'+parameters.nameValue.substring(0,4)}"/>&nbsp;
		<#else>
			&nbsp;
		</#if>
	</div>
...
></div>
<#if parameters.mostrarLeyenda?default(false)>
  DD/MM/AAAA
</#if>
