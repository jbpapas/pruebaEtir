...
public class Pagination
{
        ...
        String numberedPageSeparator, String fullBanner)
    {
        ...
        Object[] pageObjects = {
            ...
            getOpcionesIrA() // añadido 19/09/2013 jronnols
        };
    ...
    /**
     * @autor jronnols
     * @return Opciones válidas para combo "Ir a".
     */
    private String getOpcionesIrA() {
    	StringBuffer buffer = new StringBuffer();
    	if ((this.isLast() ? this.currentPage : this.lastPage) > 1) {
	    	for (int i=1; i<=(this.isLast() ? this.currentPage : this.lastPage); i++) {
	    		String value = ((Href) this.href.clone()).addParameter(this.pageParam, i).toString();
	    		buffer.append("<option value=\""+value+"\""+(i==this.currentPage?"selected=\"selected\"":"")+">"+i+"</option>");
	    	}
    	}
