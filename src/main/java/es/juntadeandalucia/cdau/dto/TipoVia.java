...
public class TipoVia  implements java.io.Serializable {
    ...
    /**
     * Gets the nombre value for this TipoVia.
     * 
     * @return nombre
     */
    ...
    /**
     * Sets the nombre value for this TipoVia.
     * 
     * @param nombre
     */
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dto.cdau.juntadeandalucia.es", "TipoVia"));
