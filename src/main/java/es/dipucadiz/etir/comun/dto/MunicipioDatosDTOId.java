...
/**
 * MunicipioDatosDTOId generated by hbm2java
 */
public class MunicipioDatosDTOId implements java.io.Serializable {

	private String coProvincia;
	private String coMunicipio;

	public MunicipioDatosDTOId() {
	}

	public MunicipioDatosDTOId(String coProvincia, String coMunicipio) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof MunicipioDatosDTOId))
			return false;
		MunicipioDatosDTOId castOther = (MunicipioDatosDTOId) other;
