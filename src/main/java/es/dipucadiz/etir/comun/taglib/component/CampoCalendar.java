 ...
 * @author SDS[DSOLIS]
 */
public class CampoCalendar extends CampoTexto2{
	/**
     * Atributo que almacena el template al que ligamos este componente.
     */
	public static final String TEMPLATE = "calendarSDS";
	
	/**
     * Atributo que almacena el nombre del componente.
     */
    final private static String COMPONENT_NAME = CampoCalendar.class.getName();
	...
	public CampoCalendar(ValueStack stack, HttpServletRequest request,
