...
public class Fecha extends DateTimePicker {
    final private static String COMPONENT_NAME = Fecha.class.getName();
    
    public static final String TEMPLATE = "gadirFecha";
    ...
    public Fecha(ValueStack stack, HttpServletRequest request,
    ...
    public void evaluateExtraParams() {
        ...
        if (!"true".equals(mostrarLeyenda)) mostrarLeyenda = "false";
        addParameter("mostrarLeyenda", findValue(mostrarLeyenda, Boolean.class));
    }
