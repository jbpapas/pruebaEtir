...
import es.dipucadiz.etir.comun.taglib.component.Combo;


public class ComboTag extends SelectTag {
    ...
    protected void populateParams() {
        ...
        combo.setConFooter(conFooter);
        combo.setConAyuda(conAyuda);
        combo.setNombreCampoAyuda(nombreCampoAyuda);
        combo.setSalida(salida);
        
        combo.setCoProcesoActual(coProcesoActual);
        

        combo.setClassLabel(classLabel);
        combo.setClassText(classText);
        combo.setStyleLabel(styleLabel);
        combo.setStyleText(styleText);
        combo.setStyleGroup(styleGroup);
    }
