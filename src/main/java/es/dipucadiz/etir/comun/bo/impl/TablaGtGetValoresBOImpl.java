...
public class TablaGtGetValoresBOImpl extends StoredProcedure implements TablaGtGetValoresBO {

	public TablaGtGetValoresBOImpl(final DataSource dataSource) {
		super(dataSource, "COMUN_UTIL.TablaGT_getValores");
		setFunction(true);
	...
	public List<Map<String, Object>> execute(final String tabla, final String elemento) {
