 ...
 */
final public class UtilidadesFormato {
	private UtilidadesFormato() {}
...
//			s = "";
//		else{
//			String a = new String(c, 0, n - s.length());
//			s = s + a;
//		}
//		
//		return s;   
...
//	}  
	...
	//Pone a la derecha de s tantos caracteres chr como sea necesario para que s tenga una longitud n 
	...
	//Pone a la izquierda de s tantos caracteres chr como sea necesario para que s tenga una longitud n 
