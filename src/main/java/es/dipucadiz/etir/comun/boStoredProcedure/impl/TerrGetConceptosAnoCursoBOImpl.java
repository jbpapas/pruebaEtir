...
public class TerrGetConceptosAnoCursoBOImpl extends StoredProcedure implements TerrGetConceptosAnoCursoBO {

	private static final Log LOG = LogFactory.getLog(TerrGetConceptosAnoCursoBOImpl.class);

	public TerrGetConceptosAnoCursoBOImpl(final DataSource dataSource) {
		super(dataSource, "CONTROL_TERRITORIAL.getConceptosAnoEnCurso");
		setFunction(true);
	...
	public List<Map<String, Object>> execute(final String provincia, final String municipio, final String codigoTerritorial) {
		...
		try {
			...
			LOG.debug("Fallo en TerrGetConceptosAnoCursoBOImpl.execute()", e);
		}
		return results;
	}
