...
import es.dipucadiz.etir.comun.boStoredProcedure.DescargaConfiguracionCompletaBO;
import es.dipucadiz.etir.comun.exception.GadirServiceException;

public class DescargaConfiguracionCompletaBOImpl extends StoredProcedure implements DescargaConfiguracionCompletaBO{
	private static final Log LOG = LogFactory.getLog(DescargaConfiguracionCompletaBOImpl.class);

	public DescargaConfiguracionCompletaBOImpl(final DataSource dataSource) {
		super(dataSource, "PQ_UTIL_CASCON.DESCARGAR_TODO");
		setFunction(true);
	...
	public Map<String, Object> execute(String coProvincia, String coMunicipio, String coConcepto) throws GadirServiceException {
		LOG.debug("Ejecuto PQ_UTIL_CASCON.DESCARGAR_TODO");
		...
		try {
			...
			LOG.error("Fallo en PQ_UTIL_CASCON.DESCARGAR_TODO", e);
		}
		return resultsList;
	}
