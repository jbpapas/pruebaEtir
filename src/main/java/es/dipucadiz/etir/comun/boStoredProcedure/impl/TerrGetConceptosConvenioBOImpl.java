...
public class TerrGetConceptosConvenioBOImpl extends StoredProcedure implements TerrGetConceptosConvenioBO {

	private static final Log LOG = LogFactory.getLog(TerrGetConceptosConvenioBOImpl.class);

	public TerrGetConceptosConvenioBOImpl(final DataSource dataSource) {
		super(dataSource, "CONTROL_TERRITORIAL.getConceptosConvenio");
		setFunction(true);
