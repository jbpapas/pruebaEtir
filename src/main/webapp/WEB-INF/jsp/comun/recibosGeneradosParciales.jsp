...
<s:if test="generadoParcial">
<script type="text/javaScript">
$(document).ready(function() {
	var msg = '<s:property value="mensajeGeneradoParcial" escape="false" />';
	var actionName = '<s:property value="actionName" escape="false" />';
	infoDialog('AVISO', msg, 'notificacionesGrabarRecibosParciales', 'mensaje=' + actionName + ': ' + msg);
});
</script>
</s:if>
